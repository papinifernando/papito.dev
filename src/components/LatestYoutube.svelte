...
<div class="flex flex-col w-full h-full">
  ...
  >
    {#if !thumbnail }
        <div
          id="placeholder"
          class="animate-pulse flex items-center justify-center h-[288px] bg-zinc-300 rounded w-[512px] bg-zinc-700"
        >
          <svg
            class="w-10 h-10 text-zinc-200 text-zinc-600"
            aria-hidden="true"
        ...
        <div role="status" class="max-w-sm animate-pulse">
          <div class="mt-4 h-4 bg-zinc-200 rounded-full bg-zinc-700 w-96"></div>
          <div class="mt-2 h-4 bg-zinc-200 rounded-full bg-zinc-700 w-48"></div>
          <div class="mt-2 grid grid-flow-col max-w-[140px]">
            <div class="h-3.5 bg-zinc-200 rounded-full bg-zinc-700 max-w-[40px]"></div>
            <div class="h-3.5 bg-zinc-200 rounded-full bg-zinc-700 max-w-[40px]"></div>
            <div class="h-3.5 bg-zinc-200 rounded-full bg-zinc-700 max-w-[40px]"></div>
          </div>
